"use strict";function _toConsumableArray(a){
    ...
    {for(var b=0,c=Array(a.length);
        ...
        {return setInterval(function()
            ...
            plus=document.getElementById("plus"),heart=document.getElementById("heart"),
            ...
            {var a=document.getElementById("counter"),b=parseInt(a.innerText)
            ;a.innerText=b+1}),heart.addEventListener("click",function()
            {var a=document.getElementById("counter"),b=parseInt(a.innerText),
